<?php
	$adresa="8323 Woodbridge Lane Maineville, OH 45039"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=5135835704;// Broj koji se poziva na dugme CALL US
